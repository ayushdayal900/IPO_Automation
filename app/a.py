...
def display_correlation_heatmaps(df, X_engineered):
    """Display correlation heatmaps for original and engineered features (SAFE & CLEAN)"""
    ...
    if not original_df.empty:
        ...
        ax.set_title("Correlation Matrix – Original Features", fontsize=16, fontweight="bold")
        plt.xticks(rotation=45, ha="right")
        plt.yticks(rotation=0)
        st.pyplot(fig)
    else:
        st.warning("No numeric data available for original features.")
    ...
    if not X_eng.empty:
        ...
        ax.set_title("Correlation Matrix – Engineered Features", fontsize=16, fontweight="bold")
        plt.xticks(rotation=45, ha="right")
        plt.yticks(rotation=0)
        st.pyplot(fig)
    else:
        st.warning("No numeric data available for engineered features.")
    ...
    with col1:
        st.markdown("""
        **Original Features**
        - Shows raw financial relationships  
    ...
    with col2:
        ...
        **Engineered Features**
        ...
        - Reflects financial domain knowledge  
